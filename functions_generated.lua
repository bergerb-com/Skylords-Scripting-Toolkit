...
---(Log) Displays a voiced text outside a Cutscene. Several Outcries can be queued as a conversation. (As opposed to MissionOutcry, which relies on the chat, Log directly logs to the log files in Documents/BattleForge/Diag.
